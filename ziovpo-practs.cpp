...
constexpr wchar_t WINDOW_CLASS_NAME[] = L"ZiovpoPract2WindowClass";
constexpr wchar_t WINDOW_TITLE[] = L"ZIoVPO Pract2";
constexpr wchar_t MUTEX_NAME[] = L"Local\\ZiovpoPract2-SingleInstance";
...
bool AddTrayIcon(HWND hwnd)
{
    ...
    StringCchCopyW(g_nid.szTip, ARRAYSIZE(g_nid.szTip), L"ZIoVPO Pract2");
